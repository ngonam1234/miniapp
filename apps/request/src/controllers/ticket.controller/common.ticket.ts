...
export async function getRequesterCreator(
    ...
    if (!objectCreator) {
        throw getCreatorError("the creator does not exist");
    }
    return {
        creator: objectCreator as unknown as IPeople,
        requester: objectRequester as unknown as IPeople,
    };
}
